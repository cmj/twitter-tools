#!/usr/bin/env bash
# Guest Twitter endpoints test (no authentication) 
# ./endpoints-guest.sh

# notes:
# only a few return results
# - UserByScreenName
# - TweetResultByRestId
# - UserTweets - sorted by most liked ("best of"): profile_best_highlights 
#     unless selected news agencies or government accounts
