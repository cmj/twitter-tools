...
# A tcl source that calls this script escapes double quotes for search:
#  regsub -all {\"} $input {%5C%22} input
# foo "bar" == foo%20%5C%22bar%5C%22 == foo \"bar\"
# I have no idea how to do this directly in bash
# so we keep data encoded:
# include%3Anativeretweets+
VARIABLES="%7B%22rawQuery%22%3A%22${query}%22%2C%22count%22%3A20%2C%22product%22%3A%22Latest%22%2C%22withDownvotePerspective%22%3Afalse%2C%22withReactionsMetadata%22%3Afalse%2C%22withReactionsPerspective%22%3Afalse%7D"
